...
param_ME <- read.csv(paste0(livestockParams_dir, "/Livestock_energy_requirement_min.csv"), stringsAsFactors = F)
...
systemMixedCrop <- raster(paste0(datadir, "/Lvst_system/w001001.adf")) #1-4 = rangelands; 5-8 = mixed systems; 9-14 = irrigated
...
terra::writeRaster(MERcattle, paste0(spatialResultsDir, "/cattleMER_MJ_2015_min.tif"), overwrite = T)
...
terra::writeRaster(MERshoats, paste0(spatialResultsDir, "/shoatsMER_MJ_2015_min.tif"), overwrite = T)
...
terra::writeRaster(MERall, paste0(spatialResultsDir, "/livestockMER_MJ_2015_min.tif"), overwrite = T)
...
param_ME <- read.csv(paste0(livestockParams_dir, "/Livestock_energy_requirement_max.csv"), stringsAsFactors = F)
#param_ME <- pivot_longer(select(param_ME, -X), cols = c("Bull", "Steer", "Calf", "Heifer", "Cow", "Lamb", "Sheep", "Kid", "Goat"))
param_ME <- pivot_longer(param_ME, cols = c("Bull", "Steer", "Calf", "Heifer", "Cow", "Lamb", "Sheep", "Kid", "Goat"))
...
###Admin level approach - comparing average daily requirements
dir.create(paste0(datadir, "/tmp"))
outIntake_TLU_DM <- lapp(lvTLU, fun = function(TLU){((TLU)*(250*0.03))}, filename = paste0(datadir, "/tmp/outIntake.tif"), overwrite = T) #, filename = 'D:/outIntake.tif', overwrite = T
...
MERcattle <- sum(MERtotalYr_DS_Sah_cattle, MERtotalYr_DS_Sud_cattle, MERtotalYr_DS_Periurban_cattle, MERtotalYr_WS_Sah_cattle, MERtotalYr_WS_Sud_cattle, MERtotalYr_WS_Periurban_cattle, na.rm = T)
terra::writeRaster(MERcattle, paste0(spatialResultsDir, "/cattleMER_MJ_2015_max.tif"), overwrite = T)

MERshoats <- sum(MERtotalYr_DS_Sah_shoats, MERtotalYr_DS_Sud_shoats, MERtotalYr_DS_Periurban_shoats, MERtotalYr_WS_Sah_shoats, MERtotalYr_WS_Sud_shoats, MERtotalYr_WS_Periurban_shoats, na.rm = T)
terra::writeRaster(MERshoats, paste0(spatialResultsDir, "/shoatsMER_MJ_2015_max.tif"), overwrite = T)

MERall <- sum(MERhorse, MERdonkey, MERtotalYr_DS_Sah_cattle, MERtotalYr_DS_Sah_shoats, MERtotalYr_DS_Sud_cattle, MERtotalYr_DS_Sud_shoats, MERtotalYr_DS_Periurban_cattle, MERtotalYr_DS_Periurban_shoats, MERtotalYr_WS_Sah_cattle, MERtotalYr_WS_Sah_shoats, MERtotalYr_WS_Sud_cattle, MERtotalYr_WS_Sud_shoats, MERtotalYr_WS_Periurban_cattle, MERtotalYr_WS_Periurban_shoats, na.rm = T)
terra::writeRaster(MERall, paste0(spatialResultsDir, "/livestockMER_MJ_2015_max.tif"), overwrite = T)
